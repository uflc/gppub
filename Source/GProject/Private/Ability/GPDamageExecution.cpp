...
struct GPDamageStatics
{
	...
	GPDamageStatics()
	{
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UGPAttributeSet, DefensePower, Target, false);
...
static const GPDamageStatics& DamageStatics()
{
	static GPDamageStatics DmgStatics;
	return DmgStatics;
}

UGPDamageExecution::UGPDamageExecution()
{
...
void UGPDamageExecution::Execute_Implementation(const FGameplayEffectCustomExecutionParameters& ExecutionParams, OUT FGameplayEffectCustomExecutionOutput& OutExecutionOutput) const
{
